...
## Question 21. What's the difference between `undefined` and `not defined` in JavaScript
...
## Question 42. Difference between `Function`, `Method` and `Constructor` calls in JavaScript.
